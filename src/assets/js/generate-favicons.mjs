...
const configuration = {
    ...
    appName: "Bruno Bergmann Homepage", // Your application's name. `string`
    appShortName: "Bruno Bergmann", // Your application's short_name. `string`. Optional. If not set, appName will be used
    appDescription: "A small website about me :)", // Your application's description. `string`
    ...
    lang: "de_DE", // Primary language for name and short_name
